...
class CGAN_changed2():
    ...
    def train(self, epochs, batch_size=128, sample_interval=50):
        ...
        img_dir = r"/content/images_change2"
    ...
    def sample_images(self, epoch, epochs, img_dir):
        if epoch == epochs-1:
            # save 50 images
            final_img_dir = os.path.join(self.gdrive_path, 'MyDrive', 'cgan_Assessment', 'Generated_covid_imgs_change2')
            ...
            for i in range(r):
                for j in range(c):
                    ...
                    axs[i][j].axis('off')
                    cnt+= 1
            fig.savefig("images_change2/%d.png" % epoch)
            plt.close()
